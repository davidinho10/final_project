...
import 'package:final_project/detail/widget/color_picker.dart';
...
class DetailAppBar extends StatefulWidget {
  ...
  const DetailAppBar(this.clothes);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      carouselController: _controller,
        ...
        items: widget.clothes.detailUrl.map((e) =>
    ...
    left: 180,
    child: Row(
    children: widget.clothes.detailUrl.asMap().entries.map((entry) => GestureDetector(
